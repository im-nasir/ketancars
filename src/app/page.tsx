...
const GALLERY_IMAGES = [
  { src: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=80&auto=format&fit=crop', alt: 'Ferrari 250 GTE' },
  { src: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?w=600&q=80&auto=format&fit=crop', alt: 'Classic Muscle Car' },
  { src: 'https://images.unsplash.com/photo-1542362567-b07e54358753?w=600&q=80&auto=format&fit=crop', alt: 'Vintage Porsche' },
  { src: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=600&q=80&auto=format&fit=crop', alt: 'Red Sports Car' },
  { src: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&auto=format&fit=crop', alt: 'Vintage Headlamps' },
  { src: 'https://images.unsplash.com/photo-1502161254066-6c74afbf07aa?w=600&q=80&auto=format&fit=crop', alt: 'Classic Black Car' },
  { src: 'https://images.unsplash.com/photo-1469285994282-454ceb49e63c?w=600&q=80&auto=format&fit=crop', alt: 'Vintage Car Detail' },
  { src: 'https://images.unsplash.com/photo-1567818735868-e71b99932e29?w=600&q=80&auto=format&fit=crop', alt: 'Classic Coupe' },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ amount: 0.3 }}
                  transition={{ duration: 0.6, delay: i * 0.12 }}
                  className="bg-[#0a0a0a] px-10 py-12"
                >
                  <p className="text-xs tracking-[0.25em] uppercase text-white/30 mb-6">{item.pub}</p>
                  <blockquote className="font-serif text-lg italic text-white/70 leading-relaxed">
